...
function Navbar() {
  return (
    <nav className="fixed top-0 left-1/2 transform -translate-x-1/2 z-50 pt-8 w-full flex justify-center">
      <ul className="flex flex-col sm:flex-row gap-4 sm:gap-8 bg-black/70 rounded-2xl px-4 sm:px-10 py-3 sm:py-4 shadow-2xl border border-blue-700 animate-fade-in animate-slide-in-down animate-duration-1000 animate-ease-in-out backdrop-blur-md w-full max-w-[98vw] sm:max-w-fit items-center">
